...
public final class PlayerMenuPlaylistLibraryRenderer {
    ...
    private PlayerMenuPlaylistLibraryRenderer() {
    }
        ...
        list.setCellFactory(owner -> new ListCell<>() {
            ...
            protected void updateItem(Song item, boolean empty) {
                ...
                try {
                    ...
                    controller.setCoverImageQuality(
                            LIST_COVER_PREFERRED_TYPE,
                            LIST_COVER_DECODE_SIZE,
                            LIST_COVER_DECODE_SIZE
                    );
                    controller.setDeferCoverResolution(true);
                    ...
                    setGraphic(cell);
                    controller.loadCoverAsync(item);
                } catch (Exception ex) {
                    ex.printStackTrace();
